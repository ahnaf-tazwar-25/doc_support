                ...
                <div id="patients">
                    <div class="container-fluid" id="container-wrapper">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Patients Appointments</h1>
                            <ol class="breadcrumb">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @else
                                                                        @if ($item->status == 'Accept')
                                                                            <label
                                                                                style="background-color: rgb(39, 236, 0); color:white"
                                                                                class="badge">Accepted</label>
                                                                        @else
                                                                            <label
                                                                                style="background-color: rgb(255, 0, 0); color:white"
                                                                                class="badge">Rejected</label>
                                                                        @endif
                                                                    @endif
                                                                </td>
