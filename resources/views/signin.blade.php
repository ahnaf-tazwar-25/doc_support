    ...
    <div class="login">
        ...
        <form action="{{ route('dashboard') }}" class="login__form" method="POST">
            ...
            <div>
                ...
                @endif
                @if (session()->has('errors'))
                    <input type="email" id="email" name="email" placeholder="mail@address.com" value="{{ session('errors')->first('email') }}" required>
                    <p class="text-danger font-weight-bold">
                        {{session('errors')->first('emailFail')}}
                    </p>
                @endif
                {{-- @error('emailFail')
            ...
            <div>
                ...
                @if (session()->has('errors'))
                    <p class="text-danger font-weight-bold">
                        {{session('errors')->first('passwordFail')}}
                    </p>
                @endif
